...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.','middleware'=>['module:business_settings']], function () {
            ...
            Route::post('return-policy', 'BusinessSettingsController@return_policy_update')->name('return-policy-update');

            Route::get('refund-policy', 'BusinessSettingsController@refund_policy')->name('refund-policy');
            Route::post('refund-policy', 'BusinessSettingsController@refund_policy_update')->name('refund-policy-update');
