...
class BusinessSettingsController extends Controller
{
    ...
    public function return_policy()
    {
        ...
        return view('admin-views.business-settings.return-policy', compact('return_policy'));
    }
    ...
    public function return_policy_update(Request $data)
    {
        ...
        BusinessSetting::where('type', 'return-policy')->update(['value' => $data->value]);
    ...
    public function refund_policy()
    {
        ...
        return view('admin-views.business-settings.refund-policy', compact('refund_policy'));
    }
    public function refund_policy_update(Request $data)
    {
        $validatedData = $data->validate([
            'value' => 'required',
        ]);
        BusinessSetting::where('type', 'refund-policy')->update(['value' => $data->value]);
