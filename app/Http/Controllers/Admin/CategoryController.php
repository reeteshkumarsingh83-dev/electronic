...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
       $validator = Validator::make($request->all(), [
            ...
            'banner_image.required' => 'Category banner image is required!',
        ...
        $category->banner = ImageManager::upload('category/', 'png', $request->file('banner_image'));
    ...
    public function update(Request $request)
    {
         $validator = Validator::make($request->all(), [
            'name' => 'required',
            'image' => 'sometimes|max:200',
            'banner_image' =>"sometimes|max:200"
        ], [
            'name.required' => 'Category name is required!',
            'image.sometimes' => 'Category image is required!',
            'banner_image.sometimes' => 'Category banner image is required!',
        ...
        if ($request->banner_image) {
            $category->banner = ImageManager::update('category/', $category->banner, 'png', $request->file('banner_image'));
        }
        $category->priority = $request->priority;
        $category->save();
