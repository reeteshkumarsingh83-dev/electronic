    ...
    public function configuration()
    {
        ...
        return response()->json([
            ...
            'base_urls' => [
                ...
                'brand_image_url' => static_assets('app/public/brand'),
                'customer_image_url' => static_assets('app/public/profile'),
                'banner_image_url' => static_assets('app/public/banner'),
                'category_image_url' => static_assets('app/public/category'),
                'review_image_url' => static_assets('app/public'),
                'seller_image_url' => static_assets('app/public/seller'),
                'shop_image_url' => static_assets('app/public/shop'),
                'notification_image_url' => static_assets('app/public/notification'),
            ],
            'static_urls' => [
