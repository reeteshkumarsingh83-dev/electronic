...
@push('css_or_js')
    <link href="{{static_assets('back-end')}}/css/select2.min.css" rel="stylesheet"/>
@endpush
                ...
                <div class="card">
                    ...
                    @if(count($cou)==0)
                        <div class="text-center p-4">
                            <img class="mb-3" src="{{static_assets('back-end')}}/svg/illustrations/sorry.svg"
...
<script>
    ...
    <script src="{{static_assets('back-end')}}/js/demo/datatables-demo.js"></script>
@endpush
