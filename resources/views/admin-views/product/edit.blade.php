...
@push('css_or_js')
    <link href="{{static_assets('back-end/css/tags-input.min.css')}}" rel="stylesheet">
    <link href="{{ static_assets('select2/css/select2.min.css')}}" rel="stylesheet">
                            ...
                            @foreach(json_decode($language) as $lang)
                                ...
                                <div class="{{$lang != 'en'? 'd-none':''}} lang_form" id="{{$lang}}-form">
                                    ...
                                    <div class="form-group pt-4">
                                        ...
                                        <textarea rows="10" type="text" name="description[]" class="form-control" required id="editor">{!! $translate[$lang]['description']??$product['details'] !!}</textarea>
                                    </div>
                                </div>
                            @endforeach
                        </div>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <img style="width: 100%" height="auto"
                                                             ...
                                                             src="{{static_assets('app/public/product/meta/'.$product->meta_image)}}"
                                                             alt="Meta image">
                                                    </div>
                                                </div>
                                            </div>
...
@push('script_2')
    <script src="{{static_assets('back-end/js/tags-input.min.js')}}"></script>
    <script src="{{static_assets('back-end/js/spartan-multi-image-picker.js')}}"></script>
    <script>
        var imageCount = {{10-count(json_decode($product->images))}};
        var thumbnail = '{{\App\CPU\ProductManager::product_image_path('thumbnail').'/'.$product->thumbnail??static_assets("back-end/img/400x400/img2.jpg")}}';
        $(function () {
            if (imageCount > 0) {
                $("#coba").spartanMultiImagePicker({
                    ...
                    maxFileSize: '',
                    placeholderImage: {
                        image: '{{static_assets("back-end/img/400x400/img2.jpg")}}',
                        width: '100%',
                    },
    ...
    {{--ck editor--}}
    <script src="{{static_assets('vendor/adapters/jquery.js')}}"></script>
