        ...
        <div class="page-header">
            <div class="media mb-3">
                ...
                <div class="avatar avatar-xl avatar-4by3 {{Session::get('direction') === "rtl" ? 'ml-2' : 'mr-2'}}">
                    <img class="avatar-img" src="{{static_assets('back-end')}}/svg/illustrations/earnings.png"
...
@push('script_2')
    ...
    <script src="{{static_assets('back-end')}}/vendor/chart.js/dist/Chart.min.js"></script>
    <script
        src="{{static_assets('back-end')}}/vendor/chartjs-chart-matrix/dist/chartjs-chart-matrix.min.js"></script>
    <script src="{{static_assets('back-end')}}/js/hs.chartjs-matrix.js"></script>
