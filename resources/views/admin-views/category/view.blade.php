                                    ...
                                    <div class="form-group">
                                        ...
                                        <center>
                                            <img
                                                ...
                                                id="viewer"
                                                src="{{static_assets('back-end/img/900x400/img1.jpg')}}"
                                                alt="image"/>
                                        </center>
                                    </div>
                                </div>
                                <div class="col-12 col-md-4 from_part_3">
                                    <label>{{\App\CPU\translate('Banner image')}}</label><small style="color: red">*
                                        ( {{\App\CPU\translate('ratio')}} 1:1 )</small>
                                    <div class="custom-file" style="text-align: left">
                                        <input type="file" name="banner_image" id="customFileEg1"
                                               class="custom-file-input"
                                               accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|banner_image/*"
                                               required>
                                        <label class="custom-file-label"
                                               for="customFileEg1">{{\App\CPU\translate('choose')}} {{\App\CPU\translate('file')}}</label>
                                    </div>
                                </div>
                                <div class="col-12 from_part_3">
                                    <div class="form-group">
                                        <hr>
                                        <center>
                                            <img
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                         ...
                                         <td>
                                            <img class="rounded" width="64"
                                                 onerror="this.src='{{static_assets("front-end/img/image-place-holder.png")}}'"
                                                 src="{{static_assets('app/public/category')}}/{{$category['banner']}}">
                                        </td>
                                        <td>
                                            {{$category['priority']}}
                                        </td>
