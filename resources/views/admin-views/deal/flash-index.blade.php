                                ...
                                <div class="col-md-12">
                                    <div style="text-align:center;">
                                        <img style="width:70%;border: 1px solid; border-radius: 10px; max-height:200px;" id="viewer"
                                            src="{{static_assets('back-end\img\1920x400\img2.jpg')}}" alt="banner image"/>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="card">
                ...
                @if(count($flash_deal)==0)
                    <div class="text-center p-4">
                        <img class="mb-3" src="{{static_assets('back-end')}}/svg/illustrations/sorry.svg" alt="Image Description" style="width: 7rem;">
...
@push('script')
    <!-- Page level plugins -->
    <script src="{{static_assets('back-end')}}/vendor/datatables/jquery.dataTables.min.js"></script>
    <script src="{{static_assets('back-end')}}/vendor/datatables/dataTables.bootstrap4.min.js"></script>
    <!-- Page level custom scripts -->

    <script src="{{static_assets('back-end')}}/js/select2.min.js"></script>
    <script>
