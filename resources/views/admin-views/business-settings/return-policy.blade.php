    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">{{\App\CPU\translate('return_policy')}}</li>
            </ol>
        </nav>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row justify-content-between pl-4 pr-4">
                            <div>
                                <h2>{{\App\CPU\translate('return_policy')}}</h2>
                            </div>
                        </div>
                    </div>
                    ...
                    <form action="{{route('admin.business-settings.return-policy-update')}}" method="post">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="col-md-12">
                                    <label for="editor">{{\App\CPU\translate('return_policy')}}</label><textarea
                                        class="form-control" id="editor"
                                        name="value">{{$return_policy->value}}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-12">
