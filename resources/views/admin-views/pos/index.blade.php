        ...
        <div class="col-md-12">
            <div id="loading" style="display: none;">
                <div style="position: fixed;z-index: 9999; left: 40%;top: 37% ;width: 100%">
                    <img width="200" src="{{static_assets('admin/img/loader.gif')}}">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="navbar-nav-wrap">
            <div class="navbar-brand-wrapper">
                ...
                <a class="navbar-brand" href="{{route('admin.dashboard')}}" aria-label="Front" style="padding-top: 0!important;padding-bottom: 0!important;">
                    <img class=""
                         style="height: 55px;"
                         onerror="this.src='{{static_assets("back-end/img/160x160/img2.jpg")}}'"
                         src="{{static_assets('app/public/company/'.$e_commerce_logo)}}"
                         alt="Logo">
                </a>         
            </div>
            <!-- Secondary Content -->
                               ...
                               data-hs-unfold-options='{
                                ...
                                <div class="avatar avatar-sm avatar-circle">
                                    <img class="avatar-img"
                                        onerror="this.src='{{static_assets("back-end/img/160x160/img1.jpg")}}'"
                                        src="{{static_assets('app/public/admin')}}/{{auth('admin')->user()->image}}"
                                        alt="Image">
...
<!-- IE Support -->
<script>
    if (/MSIE \d|Trident.*rv:/.test(navigator.userAgent)) document.write('<script src="{{static_assets("admin")}}/vendor/babel-polyfill/polyfill.min.js"><\/script>');
</script>
</body>
</html>