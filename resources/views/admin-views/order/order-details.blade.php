                                    ...
                                    @if($detail->product->added_by=='admin')
                                        <div class="row">
                                            <img
                                                ...
                                                src="{{static_assets('app/public/company/'.\App\CPU\Helpers::get_business_settings('company_web_logo'))}}"
                                                alt="Image">
                                            <p class="sellerName">
                                                <a style="color: black;"
                                                   href="javascript:">
                            ...
                            <div class="media align-items-center" href="javascript:">
                                <div class="avatar avatar-circle mr-3">
                                    <img
                                        ...
                                        onerror="this.src='{{static_assets("front-end/img/image-place-holder.png")}}'"
                                        src="{{static_assets('app/public/profile/'.$order->customer->image)}}"
                                        alt="Image">
                                </div>
                                <div class="media-body">
                                <span
    ...
    <script>
        ...
        function initializegLocationMap() {
            ...
            var marker = new google.maps.Marker({
                ...
                icon: "{{static_assets('front-end/img/customer_location.png')}}"
            });

            google.maps.event.addListener(marker, 'click', (function (marker) {
                return function () {
                    infowindow.setContent("<div style='float:left'><img style='max-height:40px;wide:auto;' src='{{static_assets('app/public/profile/')}}{{$order->customer->image??""}}'></div><div style='float:right; padding: 10px;'><b>{{$order->customer->f_name??""}} {{$order->customer->l_name??""}}</b><br/>{{$shipping_address->address??""}}</div>");
