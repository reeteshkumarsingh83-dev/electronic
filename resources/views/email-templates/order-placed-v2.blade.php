            ...
            <tr>
                ...
                <td>
                    <div style="text-align: right; margin-right:15px;">
                        ...
                        <img style="max-width:250px;border:0;" src="{{static_assets('app/public/company/'.$logo)}}" title=""
                    ...
                    <div style="text-align:left;margin-top:10px;">
                      ...
                      @if ($order->seller_is == 'seller')
                        ...
                        <div style="display:flex; align-items:center;margin-top:10px;">
                            ...
                            <img style="border:0;border-radius:50%;" src="{{static_assets('app/public/shop/'.$shop->image)}}" title=""
                        ...
                        justify-content: flex-start;">
                          @foreach ($social_media as $item)
                            ...
                            <div class="" >
                              ...
                              <img src="{{static_assets('back-end/img/'.$item->name.'.png')}}" alt="" style="height: 50px; width:50px; margin:10px;">
                              </a>
                            </div>
