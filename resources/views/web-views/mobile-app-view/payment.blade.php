                    ...
                    <div class="card-body" style="height: 100px">
                        <form action="{{ url('/pay-ssl') }}" method="POST" class="needs-validation">
                            ...
                            <button class="btn btn-block click-if-alone" type="submit">
                                <img width="150"
                                     src="{{static_assets('front-end/img/sslcomz.png')}}"/>
                            </button>
                        </form>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body" style="height: 100px">
                        <form class="needs-validation" method="POST" id="payment-form"
                            ...
                            <button class="btn btn-block click-if-alone" type="submit">
                                <img width="150"
                                     src="{{static_assets('front-end/img/paypal.png')}}"/>
                            </button>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="card-body" style="height: 100px">
                        ...
                        <!-- Note that the amount is in paise = 50 INR -->
                            ...
                            <script src="https://checkout.razorpay.com/v1/checkout.js"
                                    ...
                                    data-description=""
                                    data-image="{{static_assets('app/public/company/'.\App\Model\BusinessSetting::where(['type'=>'company_web_logo'])->first()->value)}}"
                        ...
                        <button class="btn btn-block click-if-alone" type="button"
                            ...
                            <img width="150"
                                 src="{{static_assets('front-end/img/razor.png')}}"/>
                        </button>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body" style="height: 100px">
                        ...
                        <button class="btn btn-block click-if-alone" type="button"
                            ...
                            <img width="100"
                                 src="{{static_assets('front-end/img/paystack.png')}}"/>
                        </button>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body" style="height: 100px">
                        ...
                        <button class="btn btn-block click-if-alone" type="button"
                            ...
                            <img width="100"
                                 src="{{static_assets('front-end/img/senangpay.png')}}"/>
                        </button>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body" style="height: 100px">
                        <form class="needs-validation" method="POST" id="payment-form-paymob"
                            ...
                            <button class="btn btn-block click-if-alone" type="submit">
                                <img width="150"
                                     src="{{static_assets('front-end/img/paymob.png')}}"/>
                            </button>
                        </form>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body" style="height: 100px">
                        <button class="btn btn-block click-if-alone" id="bKash_button" onclick="BkashPayment()">
                            <img width="100" src="{{static_assets('front-end/img/bkash.png')}}"/>
                        </button>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body" style="height: 100px">
                        <button class="btn btn-block click-if-alone" onclick="location.href='{{route('paytabs-payment')}}'" style="margin-top: -11px">
                            <img width="150" src="{{static_assets('front-end/img/paytabs.png')}}"/>
                        </button>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body" style="height: 100px">
                        <button class="btn btn-block" onclick="location.href='{{route('fawry')}}'" style="margin-top: -11px">
                            <img width="150" src="{{static_assets('front-end/img/fawry.svg')}}"/>
                        </button>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body" style="height: 100px">
                        <a class="btn btn-block click-if-alone" onclick="location.href='{{route('mercadopago.index')}}'">
                            <img width="150" src="{{static_assets('front-end/img/MercadoPago_(Horizontal).svg')}}"/>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body" style="height: 100px">
                        <form method="POST" action="{{ route('flutterwave_pay') }}">
                            ...
                            <button class="btn btn-block click-if-alone" type="submit">
                                <img width="200"
                                    src="{{static_assets('front-end/img/fluterwave.png')}}"/>
                            </button>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="card-body" style="height: 100px">
                        <a class="btn btn-block click-if-alone" href="{{route('paytm-payment')}}">
                            <img style="max-width: 150px; margin-top: -10px"
                                 src="{{static_assets('front-end/img/paytm.png')}}"/>
                        </a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body" style="height: 100px">
                        <a class="btn btn-block click-if-alone" href="{{route('liqpay-payment')}}">
                            <img style="max-width: 150px; margin-top: 0px"
                                 src="{{static_assets('front-end/img/liqpay4.png')}}"/>
                        </a>
                    </div>
                </div>
            </div>
...
<script src="{{ static_assets('front-end')}}/vendor/jquery/dist/jquery-2.2.4.min.js"></script>
