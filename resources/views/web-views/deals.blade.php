...
@section('content')
    <div class="container-fluid listing_banner" style="background-size: cover; padding: 0px;">    
       <img onerror="this.src='{{static_assets("front-end/img/image-place-holder.png")}}'" src="{{static_assets('app/public/deal')}}/{{$deal['banner']}}" alt="">
    </div> 
                ...
                <div class="row mt-4">
                    @if($discountPrice)
                        @foreach($deal->products as $dp)
                            @if (isset($dp->product))
                                <div class="col-xl-3 col-sm-3 col-6" style="margin-bottom: 10px">
