...
<div class="container rtl" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
    <div class="row">
        <div class="col-12 mt-5">
            <center>
                <img style="width: 350px!important;" src="{{static_assets('front-end')}}/img/maintenance-mode.jpg">
...
{{--<script src="{{static_assets('front-end')}}/vendor/jquery/dist/jquery.slim.min.js"></script>--}}
