...
@push('css_or_js')
    ...
    @if($product['meta_image']!=null)
        <meta property="og:image" content="{{static_assets('app/public/product/meta')}}/{{$product->meta_image}}"/>
        <meta property="twitter:card"
              content="{{static_assets('app/public/product/meta')}}/{{$product->meta_image}}"/>
    @else
        <meta property="og:image" content="{{static_assets('app/public/product/thumbnail')}}/{{$product->thumbnail}}"/>
        <meta property="twitter:card"
              content="{{static_assets('app/public/product/thumbnail/')}}/{{$product->thumbnail}}"/>
    @endif
    ...
    <link rel="stylesheet" href="{{static_assets('front-end/css/product-details.css')}}"/>
    <style>
        .msg-option {
            display: none;
        }
...
@section('content')
    ...
    <div class="container mt-4 rtl" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
        ...
        <div class="row" style="direction: ltr">
            ...
            <div class="col-md-9 col-12">
                <div class="row">
                                    ...
                                    @foreach (json_decode($product->images) as $key => $photo)
                                        <div
                                            ...
                                            <img class="cz-image-zoom img-responsive" style="width:100%;height:auto"
                                                ...
                                                src="{{static_assets('app/public/product/'.$photo)}}"
                                                data-zoom="{{static_assets('app/public/product/'.$photo)}}"
                    ...
                    <div class="col-lg-7 col-md-8 col-12 mt-md-0 mt-sm-3" style="direction: {{ Session::get('direction') }}">
                        <div class="details">
                            ...
                            <div class="row product-details-shipping-details">
                                 <div class="col-4">
                                     <img class="{{Session::get('direction') === "rtl" ? 'float-right ml-2' : 'mr-2'}}"  src="{{static_assets('front-end/png/Payment.png')}}"
                                                alt="">
                                 </div>
                                 <div class="col-4">
                                     <img class="{{Session::get('direction') === "rtl" ? 'float-right ml-2' : 'mr-2'}}"  
                                            src="{{static_assets('front-end/png/money.png')}}"
                                                alt="">
                                 </div>
                                 <div class="col-4">
                                     <img class="{{Session::get('direction') === "rtl" ? 'float-right ml-2' : 'mr-2'}}"
                                            src="{{static_assets('front-end/png/Genuine.png')}}"
                                            alt="">
                                 </div>
                             </div>
                        </div>
                ...
                <div class="row">
                    <div class="rtl col-12" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                        <div class="row" >
                            <div class="col-12">
                                <div class=" mt-1">
                                    <!-- Tabs-->
                                    ...
                                    <div class="px-4 pt-lg-3 pb-3 mb-3 mr-0 mr-md-2" style="background: #ffffff;border-radius:10px;min-height: 278px;">
            ...
            <div class="col-md-3 ">
                ...
                @php($more_product_from_seller = App\Model\Product::where('added_by',$product->added_by)->where('user_id',$product->user_id)->latest()->take(6)->get())
                <div style="">
    ...
    <div class="container  mb-3 rtl pt-4" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
        <div class="text-capitalize text-center p-3" style="font-weight: 700; font-size: 30px;{{Session::get('direction') === "rtl" ? 'margin-right: 5px;' : 'margin-left: 5px;'}}">
            <span>{{ \App\CPU\translate('SIMILAR PRODUCTS')}}</span>
        </div>
        ...
        <div class="row mt-4">
            @if (count($relatedProducts)>0)
                @foreach($relatedProducts->take(8) as $key => $relatedProduct)
                    <div class="col-xl-3 col-sm-3 col-6" style="margin-bottom: 20px;">
