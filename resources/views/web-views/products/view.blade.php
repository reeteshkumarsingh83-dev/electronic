...
@push('css_or_js')
    <meta property="og:image" content="{{static_assets('app/public/company')}}/{{$web_config['web_logo']}}"/>
    <meta property="og:title" content="Products of {{$web_config['name']}} "/>
    <meta property="og:url" content="{{env('APP_URL')}}">
    <meta property="og:description" content="{!! substr($web_config['about']->value,0,100) !!}">

    <meta property="twitter:card" content="{{static_assets('app/public/company')}}/{{$web_config['web_logo']}}"/>
...
<?php
    if($data['data_from'] == 'brand'){
        $image    = 'top.png';
    }elseif($data['data_from'] == 'category'){
        $image1    = \App\Model\Category::where('id',$data['id'])->first();
        $image    = $image1->banner; 
    }elseif($data['data_from'] == 'top-rated'){
        $image    = 'top.png';
    }elseif($data['data_from'] == 'best-selling'){
        $image    = 'top.png';
    }elseif($data['data_from'] == 'featured_deal'){
        $image    = 'top.png';
    }else{
        $image    = '';
    }
...
@section('content')
@if($image != null)
<div class="container-fluid listing_banner" style="background-size: cover; padding: 0px;">    
   <img src="{{static_assets('app/public/category/'.$image) ?? ''}}" alt="">
</div> 
@endif
    <!-- Page Title-->
    <div class="d-flex justify-content-center align-items-center mb-1" style="min-height: 70px;background:{{$web_config['primary_color']}}10;width:100%;">
                    ...
                    <div class="mt-3" >
                        ...
                        <div class="text-center">
                            ...
                            <div class="d-flex justify-content-between" style="width: 100%;padding: 14px;padding-top: 30px; ">
                                ...
                                <div style="width: 20%;background:#9d7bc5;width:30px;height:35px;border-radius:3px;" class="d-flex justify-content-center align-items-center">
...
@push('script')
    <script>
        function openNav() {
            ...
            document.getElementById("mySidepanel").style.height = "95vh";
        }
