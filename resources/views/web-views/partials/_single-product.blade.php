        ...
        <div class="d-flex d-block" style="cursor: pointer;">
            <a href="{{route('product',$product->slug)}}">
                <img src="{{static_assets('app/public/product/thumbnail/'.$product->thumbnail)}}"
                    onerror="this.src='{{static_assets("front-end/img/image-place-holder.png")}}'" class="product_image_size">
            </a>
        </div>
    </div>
    <div class="single-product-detail" style="position:relative;height:85px;padding-top:10px;border-radius: 0px 0px 5px 5px; ">
