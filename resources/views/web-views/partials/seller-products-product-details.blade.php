@if(isset($product))
    ...
    <div class="flash_deal_product rtl" style="cursor: pointer; height:175px; margin-bottom:10px;"
        ...
        <div class=" d-flex" style="">
            <div class=" d-flex align-items-center justify-content-center"
                ...
                <div class="flash-deals-background-image" style="background: {{$web_config['primary_color']}}10">
                    <img style="height: 155px!important;width:125px!important;border-radius:5px;"
