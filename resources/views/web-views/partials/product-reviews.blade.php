        ...
        <div
            ...
            <div
                ...
                <img style="max-height: 64px;"
                    ...
                    src="{{static_assets('app/public/profile')}}/{{(isset($productReview->user)?$productReview->user->image:'')}}"
            ...
            @if (!empty(json_decode($productReview->attachment)))
                @foreach (json_decode($productReview->attachment) as $key => $photo)
                    <img
                        ...
                        onclick="showInstaImage('{{static_assets("app/public/review/$photo")}}')"
                        class="cz-image-zoom"
                        onerror="this.src='{{static_assets("front-end/img/image-place-holder.png")}}'"
                        src="{{static_assets('app/public/review/$photo')}}"
