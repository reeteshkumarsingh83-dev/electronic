        ...
        <div class="navbar-nav-wrap">
            <div class="navbar-brand-wrapper">
                ...
                <a class="navbar-brand" href="{{route('admin.dashboard.index')}}" aria-label="">
                    <img class="navbar-brand-logo" style="max-height: 42px; width: 42px;"
                         onerror="this.src='{{static_assets("front-end/img/image-place-holder.png")}}'"
                         src="{{static_assets('app/public/company/'.$e_commerce_logo)}}" alt="Logo">
                    <img class="navbar-brand-logo-mini" style="max-height: 42px; width:42px"
                         onerror="this.src='{{static_assets("front-end/img/image-place-holder.png")}}'"
