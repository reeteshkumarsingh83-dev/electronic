            ...
            <div class="navbar-brand-wrapper">
                ...
                <a class="navbar-brand" href="{{route('seller.dashboard.index')}}" aria-label="">
                    ...
                    <img class="navbar-brand-logo" style="max-height: 42px;"
                            ...
                            src="{{static_assets('app/public/shop/$shop->image')}}" alt="Logo" height="40" width="40">
                    ...
                    @else
                        <img class="navbar-brand-logo-mini" style="max-height: 42px;"
                                src="{{static_assets('back-end/img/160x160/img1.jpg')}}"
                                alt="Logo" height="40" width="40">
                    @endif
                                        ...
                                        @foreach(json_decode($lang['value'],true) as $data)
                                            @if($data['code']==$local)
                                                <img class="{{Session::get('direction') === "rtl" ? 'ml-2' : 'mr-2'}}" width="20"
                                                     src="{{static_assets('front-end')}}/img/flags/{{$data['code']}}.png"
                                                     alt="Eng">
                                                {{$data['name']}}
                                            @endif
                                        @endforeach
                            ...
                            <a class="js-hs-unfold-invoker navbar-dropdown-account-wrapper" href="javascript:;"
                               data-hs-unfold-options='{
                                ...
                                <div class="avatar avatar-sm avatar-circle">
                                    {{-- <img src="{{static_assets('app/public/seller/'.auth('seller')->user()->image)}}"  onerror="this.src='{{static_assets("front-end/img/image-place-holder.png")}}'" class="img-profile rounded-circle"> --}}
