...
@push('css_or_js')
    <style>
        ...
        .inbox_people {
            ...
            float: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};
            overflow: hidden;
            border- {{Session::get('direction') === "rtl" ? 'left' : 'right'}}: 1px;
        }
        ...
        .chat_ib {
            float: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};
            padding: {{Session::get('direction') === "rtl" ? '0 15px 3px 0' : '0 0 3px 15px'}};
            margin-top: 0.56rem;
        }
                                ...
                                @foreach($chattings_user as $key => $chatting)
                                    <div class="chat_list @if ($key == 0) active @endif"
                                        ...
                                        <div class="chat_people" id="chat_people">
                                            <div class="chat_img">
                                                <img src="{{static_assets('app/public/profile/'.$chatting->image)}}"
                                                ...
                                                <div class="incoming_msg">
                                                    <div class="incoming_msg_img">
                                                        <img style="width: 30px;height: 30px;border-radius: 50%"
                                                             src="{{static_assets('app/public/profile/'.$message->image)}}"
                                                             onerror="this.src='{{static_assets("/front-end/img/image-place-holder.png")}}'"
                                                             alt="">
                                                    </div>
                ...
                $.ajax({
                  ...
                  <div class="incoming_msg" id="incoming_msg">
                    <div class="incoming_msg_img" id="">
                      <img src="${window.location.origin}/app/public/profile/${element.image}" style="border-radius: 10px;" alt="">
                    </div>
                    <div class="received_msg">
                      <div class="received_withd_msg">
