...
<main id="content" role="main" class="main" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
    <div class="position-fixed top-0 right-0 left-0 bg-img-hero"
         style="height: 32rem; background-image: url({{static_assets('admin')}}/svg/components/abstract-bg-4.svg);">
        <!-- SVG Bottom Shape -->
    ...
    <div class="container py-5 py-sm-7">
        ...
        <a class="d-flex justify-content-center mb-5" href="javascript:">
            <img class="z-index-2" src="{{static_assets('app/public/company/'.$e_commerce_logo)}}" alt="Logo"
                 onerror="this.src='{{static_assets("back-end/img/400x400/img2.jpg")}}'"
                 style="width: 8rem;">
        </a>
                                ...
                                {{--<a class="btn btn-lg btn-block btn-white mb-4" href="#">
                                    <span class="d-flex justify-content-center align-items-center">
                                      <img class="avatar avatar-xss mr-2"
                                           src="{{static_assets('admin')}}/svg/brands/google.svg" alt="Image Description">
                                      Sign in with Google
                                    </span>
                                </a>
