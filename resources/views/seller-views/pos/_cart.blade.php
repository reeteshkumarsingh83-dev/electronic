            ...
            @if(session()->has($cart_id) && count( session()->get($cart_id)) > 0)
                ...
                <tr>
                    <td class="media align-items-center">
                        <img class="avatar avatar-sm mr-1" src="{{static_assets('app/public/product/thumbnail')}}/{{$cartItem['image']}}"
                                onerror="this.src='{{static_assets("back-end/img/160x160/img2.jpg")}}'" alt="{{$cartItem['name']}} image">
